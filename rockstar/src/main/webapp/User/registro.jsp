...
<%@page import="co.com.rockstar.center.repository.UserRepositoryImpl"%>
<%@page import="co.com.rockstar.center.bean.User"%>
<%@page import="co.com.rockstar.center.repository.Repository"%>
...
<div class="container">
    ...
    <nav></nav>
    <section>
        <form method="post" action="RegisterUserxd" >
            <h3>Productos</h3>
            <%
                User uss = new User();
            ...
            <input value="<%=uss.getImage() != null ? uss.getImage() : ""%>" type="text" id="image" name="image" class="form-control" placeholder="Ingrese cimage" required autofocus
                   ><br><br>
        ...
        <table class="table">
            ...
            <%    Repository<User> repository = new UserRepositoryImpl();
                try {
                    List<User> Productos = repository.listAllObj();
                    for (User user : Productos) {


            %>
            <tr>
                <td><form action="/autowashcenter-1/User" method="post">
                ...
                <td>
                    <form action="/autowashcenter-1/User" method="post">
